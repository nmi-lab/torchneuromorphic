...
from torchneuromorphic.datasets.nmnist.nmnist_dataloaders import NMNISTDataset, sample, create_datasets
...
try:
    ...
    print('Double NMNIST dataset requires torchmeta installed https://github.com/tristandeleu/pytorch-meta')
    raise
