...
# Licence : GPLv2
#----------------------------------------------------------------------------- 
from dvsgestures_dataloaders_meta import *
from torchneuromorphic.utils import plot_frames_imshow
import matplotlib.pyplot as plt

if __name__ == "__main__":
    root = '/Users/k_stewart/chouti/data/dvs_gesture_meta.hdf5' #'/home/kennetms/Documents/snn_maml/data/nomniglot/nomniglot.hdf5'
